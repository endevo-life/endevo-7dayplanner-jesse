...
const CaptureScreen: React.FC<CaptureScreenProps> = ({ onSubmit }) => {
  ...
  return (
    <div className="capture-screen">
      ...
      {/* Top nav with ENDevo logo */}
      <nav className="capture-nav">
        <img src="/logo_v2_with_white_text.png" alt="ENDevo" className="capture-nav-logo" />
      </nav>
      ...
      <div className="capture-card">
        ...
        <div className="capture-avatar">
          ...
          <div className="capture-avatar-inner">
            <img src="/jesse-logo.png" alt="Jesse" className="capture-jesse-img" />
          </div>
        </div>
